...
class User extends Model
{
    ...
    public static function listAll(){
        ...
        return $sql -> select("SELECT * FROM tb_users INNER JOIN tb_persons b USING
    ...
    public function get ($iduser){
        ...
        $results = $sql->select("SELECT * FRM tb_users a INNER JOIN tb_persons
        b USING(idperson) WHERE a.iduser = :iduser", array(
            ":iduser"=>$iduser
        ));
        $this->setData($results[0]);
    ...
    public function update(){
        ...
        $results = $sql->select("CALL sp_usersupdate_save(:iduser, :desperson,
         :deslogin, :despassword, :desemail, :nrphone, :inadmin)", array(
